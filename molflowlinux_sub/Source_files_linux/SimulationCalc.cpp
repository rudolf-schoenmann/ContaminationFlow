...
boost::multiprecision::float128 calcDesorption(SubprocessFacet *iFacet, Databuff *hitbuffer){//This returns ((d'coverage')/dt)de. So to speak desorption rate in units of [1/s]
	...
	boost::multiprecision::float128 d= boost::multiprecision::tanh((static_cast<boost::multiprecision::float128>(1.)-coverage) * static_cast<boost::multiprecision::float128>((2.*tuneE)/p->W_tr)) * static_cast<boost::multiprecision::float128>((1.-0.)/2.) +static_cast<boost::multiprecision::float128>((1.+0.)/2.);
