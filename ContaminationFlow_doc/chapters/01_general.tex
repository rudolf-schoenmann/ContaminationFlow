...
%\draw [help lines] (0,0) grid (4,4);
	\node (Windows)[textbox, rectangle split, rectangle split parts=2] at (0,4)
	{
		...
		\nodepart{second}
			\begin{itemize}[noitemsep,topsep=0pt,leftmargin=*] \item GUI \item Create Geometry \item Set parameters \item View profiles \end{itemize}
	};
	...
	\node (Linux)[textbox, rectangle split, rectangle split parts=2] at (11,4)
	{
		...
		\nodepart{second}
			\begin{itemize}[noitemsep,topsep=0pt,leftmargin=*] \item Command line \item Parallel simulation \item Update of hitbuffer \end{itemize}	
	};
