...
%\draw [help lines] (0,0) grid (4,4);
	...
	\node (Linux)[textbox, rectangle split, rectangle split parts=2] at (11,4)
	{
		...
		\nodepart{second}
			\begin{itemize}[noitemsep,topsep=0pt,leftmargin=*] \item Command line \item Parallel simulation \item Monitor covering, statistical error, particle density, pressure per iteration \item Update of hitbuffer \end{itemize}	
	};
