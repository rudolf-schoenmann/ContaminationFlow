...
\hline
\rule{0pt}{3ex} molflowpath& Path of github directory\\
...
\rule{0pt}{3ex} convert\_to/from\_molflowdir() & Exchange MOLFLOWDIR and \codew{p$\rightarrow$molflowpath}\\
\hline
\end{tabular}
\end{center}
...
\rule{0pt}{3ex} \multirow{2}{*}{calctotalDesorption}& Calculate desorption for\\
