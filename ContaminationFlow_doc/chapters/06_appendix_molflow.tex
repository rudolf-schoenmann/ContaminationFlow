...
\rule{0pt}{3ex} initCurrent()& Initializes size of currentList\\
\rule{0pt}{3ex} initStatistics()& Initializes size of statisticsList\\
\rule{0pt}{3ex} initList()& Initializes size of historyList\\
\rule{0pt}{3ex} appendCurrent()& Appends currentList to historyList\\
\rule{0pt}{3ex} appendList()& Append input list to historyList\\
\rule{0pt}{3ex} updateStatistics()& Calculates statistics and save to statisticsList\\
...
\rule{0pt}{3ex} empty()& Checks if historyList is empty\\
...
\rule{0pt}{3ex} appendList()& Updates coveringList\\
\rule{0pt}{3ex} erase()& Erases desired point in history\\
...
\rule{0pt}{3ex}  counterWindowPercent&  Percentage of step size at which velocity counters are increased\\
\rule{0pt}{3ex}  desWindowPercent&  Percentage of step size at which desorption occurs\\
...
\rule{0pt}{3ex} writeInputfile()& Write to terminal\\
\hline
\end{tabular}
\end{center}
%\newpage
...
\rule{0pt}{3ex} updateStatistics()& Statistics over \codew{p$\rightarrow$rollingWindowSize} iterations\\ 
\hline
...
\hline
\rule{0pt}{3ex} convertunit()& Converts simutime $\cdot$ unit to milliseconds\\
\hline
\end{tabular}
\end{center}
\newpage
...
\hline
\rule{0pt}{3ex} \multirow{2}{*}{UpdateErrorSub()}& Calculates error per facet, see eq.\ \ref{eq:error}\\&Saves to \codew{simHistory}\\
\rule{0pt}{3ex} \multirow{2}{*}{UpdateErrorAll()}& Sums up total error of facets \& weights by facet area \\ & for all possible error types\\
\rule{0pt}{3ex} UpdateError()& Returns total error of desired error type\\
\rule{0pt}{3ex} CheckErrorSub()& Checks if total error and vip facet error reached target\\
\hline
\multicolumn{2}{l}{}\\
\hline
...
\hline
\rule{0pt}{3ex} getStepSize()& Calculates step size for current step, see eq.\ \ref{eq:tstep}\\
...
\rule{0pt}{3ex} \multirow{3}{*}{UpdateErrorMain()}& Calculates total error for each facet, see eq.\ \ref{eq:error}\\
