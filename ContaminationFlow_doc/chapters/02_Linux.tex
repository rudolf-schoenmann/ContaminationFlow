...
\code{class SimulationHistory \{\\
	...
	[0.5\baselineskip]
	\hphantom{\enskip}HistoryList<uint\_128t> coveringList;\\
...
\begin{tikzpicture}[node distance=2cm, font=\scriptsize]
	...
	\node[neuron](facet) at (6,-7.4) {Find next facet};
...
\item Iteration until \codew{p$\rightarrow$maxTimeS} or \codew{p$\rightarrow$convergenceTarget} is reached: \smallskip
	\begin{itemize}[noitemsep,topsep=0pt, partopsep=0pt]
